...
`http://${CLUSTER_NAME}-backup-sidecar:19999/backup?etcdVersion=${ETCD_VERSION}` . For example:
```
$ curl "http://etcd-cluster-backup-sidecar:19999/backup?etcdVersion=v3.1.0" -o v3.1.0_etcd.backup
```
